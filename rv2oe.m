...
% Inputs:                                                                 %
%--------                                                                  
%r_ECI (km)                  [3 x N]                         Position Vector in
%                                                       ECI coordinate
%                                                       frame of reference
%
%v_ECI (km/s)                  [3 x N]                         Velocity vector in
%                                                       ECI coordinate
%                                                       frame of reference
%
...
angles_in_deg = rad2deg([i,O,o,nu,truLon,argLat]);
i = angles_in_deg(1);
O = angles_in_deg(2);
o = angles_in_deg(3);
nu = angles_in_deg(4);
truLon = angles_in_deg(5);
argLat = angles_in_deg(6);
